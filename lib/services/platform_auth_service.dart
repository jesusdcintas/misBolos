...
class PlatformAuthService {
  ...
  Future<bool> _signInMacOS() async {
    try {
      ...
      debugPrint('[PlatformAuth] macOS OAuth initiated - waiting for callback...');
      ...
      if (SupabaseService.instance.isAuthenticated) {
        debugPrint('[PlatformAuth] macOS OAuth success: ${SupabaseService.instance.userEmail}');
        return true;
      }
      
      debugPrint('[PlatformAuth] macOS OAuth - user completing auth in browser');
  ...
  Future<bool> signInSilently() async {
    ...
    try {
      ...
      if (_idToken != null && _accessToken != null) {
        await SupabaseService.instance.signInWithGoogle(_idToken!, _accessToken!);
      }
  ...
  Future<bool> reconnectSupabase() async {
    ...
    try {
      ...
      if (_idToken != null && _accessToken != null) {
        return await SupabaseService.instance.signInWithGoogle(_idToken!, _accessToken!);
      }
      return false;
    } catch (e) {
